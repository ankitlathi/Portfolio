...
export const Home = () => {
    ...
    return(
        <>
        <Navbar/>
        <div className="dark flex flex-col items-center min-h-screen bg-gradient-to-br from-slate-900 to-slate-800  md:px-20 pt-20 ">
            {/* ====================Navigation Bar==================== */}
            ...
            <section className="mb-16" id="home">
                ...
                <div className="text-center md:text-xl text-white opacity-85 mt-6">
                    <p>Crafting exceptional digital experience with modern technologies.</p>
                    <p>Specializing in React, Node.js, Three.js and cutting edge web technology.</p>
                </div>
            </section>
            <div className="md:w-[80vw] flex flex-col items-center justify-center">
                <Cube/>
                <h2 className="mt-12 text-white animate-pulseFont text-sm font-light hidden md:block">Tap and move to explore</h2>
            </div>
        ...
        <div className="dark flex flex-col items-center min-h-screen bg-gradient-to-b from-slate-800 to bg-slate-900 ">
            <section className="flex max-w-6xl flex-col items-center" id="skills">
                <div className="mt-20 w-[80%]">
                    <h1 className="text-3xl md:text-5xl text-white text-center">Techincal Excellence</h1>
                    <p className="text-gray-300 text-center mt-6 text-sm md:text-lg">Mastering the latest technologies to build scalable, performant applications that deliver exceptional user experiences.</p>
                </div>

                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 px-2 my-12 w-full">
            ...
            <section className="mx-8 max-w-6xl px-2 md:px-0" id="projects">
                ...
                <div className="mt-8  md:grid md:grid-cols-2 gap-8" >
                        ...
                        {/* Background "inverted" card */}
                            <div className="absolute w-[97%] md:w-full  inset-0 bg-gradient-to-br from-blue-800 to-purple-800 rounded-2xl rotate-2 translate-x-2 translate-y-2 transition-transform duration-300  group-hover:rotate-[5deg] group-hover:scale-105">
                            </div>
                            <div className="ml-2 relative transition-transform duration-300  w-full h-64  md:h-80 bg-white rounded-2xl shadow-lg -rotate-1 hover:scale-105 bg-gradient-to-br from-blue-800 to-purple-800">
                ...
                <div className="mt-24 grid md:grid-cols-2 gap-8">
                    <div className="relative group h-64 px-2 flex md:hidden">
                    {/* Background "inverted" card */}
                        <div className="absolute w-[97%]  inset-0 bg-gradient-to-br from-green-500 to-green-800 rounded-2xl -rotate-2 translate-x-2 translate-y-2 transition-transform duration-300  group-hover:rotate-[-5deg] group-hover:scale-105">
                        </div>
                        <div className="ml-2 relative transition-transform duration-300  w-full h-64 bg-white rounded-2xl shadow-lg rotate-1 hover:scale-105 bg-gradient-to-br from-green-500 to-green-800">
                    ...
                    <div className="px-4 mt-3">
                        ...
                        <div className="relative group  h-80 hidden md:flex">
                        {/* Background "inverted" card */}
            ...
            <section className=" mt-32 flex flex-col items-center w-[90vw] md:w-full " id="contact">
                <h1 className="text-3xl md:text-5xl text-white">Let's Work Together</h1>
                <p className="w-[90%] md:w-[60%] text-gray-300 mt-4 text-center">Ready to bring your ideas to life? Let's discuss your next project and create something amazing together.</p>
            
                <div className="grid md:grid-cols-2 gap-10 max-w-6xl my-12 border-b border-slate-700">
                    <div className="flex flex-col items-start">
                        <h1 className="text-white text-xl md:text-2xl text-left">Get In Touch</h1>
                        <p className="text-gray-300 text-sm md:text-lg my-4">I'm always interested in new opportunities and exciting projects. Whether you have a project in mind or just want to connect, feel free to reach out.</p>
                        <div className="flex mt-4">
                            <div className="h-10 md:h-12 w-10 md:w-12 flex justify-center items-center rounded-xl bg-gradient-to-br from-blue-600 to-sky-600"><MapPin size={20} className="text-white"/></div>
                        ...
                        <div className="flex mt-4">
                            <div className="h-10 md:h-12 w-10 md:w-12 flex justify-center items-center rounded-xl bg-gradient-to-br from-pink-700 to-pink-400"><Phone size={20} className="text-white"/></div>
                            <div className=" ml-4 text-sm md:text-base">
                        ...
                        <div className="flex mt-4">
                            <div className="h-10 md:h-12 w-10 md:w-12 flex justify-center items-center rounded-xl bg-gradient-to-br from-green-400 to-green-700"><Mail size={20} className="text-white"/></div>
                            <div className=" ml-4 text-sm md:text-base">
                    ...
                    <div className="bg-slate-700 opacity-80 rounded-xl p-4 py-6 md:py-8 md:p-8 mb-16">
                        ...
                        />
                        <button type="submit"
                        className="w-full text-sm md:text-base flex justify-center bg-gradient-to-r from-sky-500 to-blue-700 text-white py-2 rounded-xl hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-800"
            ...
            <div className="text-slate-400 mb-12 md:mb-24 text-center w-[90vw] text-sm md:text-md">
                    © 2025 Ankit Lathi.
